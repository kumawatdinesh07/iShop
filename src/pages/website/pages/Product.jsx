                        ...
                        <div className="w-full mb-8 md:w-1/2 md:mb-0">
                            <div className="sticky top-0 z-50 overflow-hidden ">
                                <div className="relative mb-6 lg:mb-10 lg:h-2/4 ">
                                    <img
                                        src={prodImgUrl + productDetails[0].image}
                                        alt=""
                                ...
                                <div className="px-6 pb-6 mt-6 border-t border-gray-300 dark:border-gray-400 ">
                                    ...
                                    <div className="mt-2 px-7">
                                        <div className="text-sm text-blue-400 dark:text-blue-200" href="#">
                                            Get delivery dates
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="lg:pl-20">
                                <div className="mb-8 ">
                                    ...
                                    <p className="inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                                        <span> ${productDetails[0].final}</span>
                                ...
                                <div className="mb-8">
                                    ...
                                    <div className="flex flex-wrap -mx-2 -mb-2">
                                        {/* {
                                            productDetails[0].colorData.map(
                                                (col, i) => {
                                                    return (
                                        ...
                                        <button className="p-1 mb-2 mr-3 ">
                                            <div className={`w-6 h-6 rounded-full bg-[${productDetails[0].colorData.name}]`} />
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-wrap items-center gap-4">
                                    <button onClick={dispatch(addToCart({ prodId: productDetails[0]._id }))} className="w-full p-4 bg-blue-500 rounded-md lg:w-2/5 dark:text-gray-200 text-gray-50 hover:bg-blue-600 dark:bg-blue-500 dark:hover:bg-blue-700">
                                        Add to cart
                                    </button>
